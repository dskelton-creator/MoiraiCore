...
AGENT_DEFINITIONS = {
    ...
    "seo": {
        ...
        "status": "active",
        "model": "Inherits from Hermes",
        "memory_folder": "agents/seo",
        "skills": ["seo-toolkit"],
        "toolsets": ['web,search,session_memory,clarify'],
        "strengths": [
            "Full site SEO audits (scoring, recommendations)",
            "Keyword research & TF-IDF analysis",
            "Content analysis (structure, readability, links)",
            "Site crawling (broken links, thin pages, speed)",
            "Competitor head-to-head comparison",
            "JSON-LD schema generation (10 types)",
            "Backlink analysis (anchor texts, dofollow/nofollow)",
            "SERP visibility tracking",
            "Australian local SEO (AU business schema, AU keyword targeting)",
        ],
        "triggers": [
            "seo", "search engine", "keyword", "keywords", "ranking",
            "serp", "google ranking", "meta description", "title tag",
            "backlink", "crawl", "site audit", "content analysis",
            "schema", "json-ld", "local seo", "readability",
            "alt text", "canonical", "robots", "sitemap",
            "competitor seo", "keyword density", "seo score",
            "organic traffic", "search visibility", "page speed",
        ],
        "description": "Local SEO toolkit — audits, keyword research, content analysis, site crawling, competitor comparison, schema generation, backlink analysis. All on-machine, zero API costs.",
        "output_pattern": "agents/seo/reports/",
    },
    "threat": {
        "name": "Threat & Risk Analyst",
        "emoji": "🛡️",
        "role": "Cyber Security Threat Modelling & Risk Assessment",
        "status": "active",
        "model": "Inherits from Hermes",
        "memory_folder": "agents/threat",
        "skills": ["security-review-docker"],
        "toolsets": ['web,search,terminal,file,session_memory,clarify'],
        "strengths": [
            "STRIDE threat modelling per asset/data flow",
            "NIST SP 800-30 Rev.1 risk assessment (likelihood × impact)",
            "NIST SP 800-37 Rev.2 RMF step tracking",
            "NIST SP 800-53 Rev.5 control mapping",
            "NIST CSF 2.0 category mapping",
            "Residual risk analysis (pre/post mitigation)",
            "Bowtie analysis (threats → consequences + barriers)",
            "Executive report generation (board-ready markdown)",
            "Threat source catalogue (adversarial, accidental, structural, environmental)",
            "KinlyPro security architecture & compliance (ISO 27001, AU Privacy Act)",
        ],
        "triggers": [
            "threat", "threat model", "threat modelling", "stride",
            "risk assessment", "risk analysis", "risk register",
            "nist", "sp 800-30", "sp 800-37", "sp 800-53", "rmf",
            "cybersecurity", "cyber security", "security assessment",
            "vulnerability", "exploit", "attack vector", "attack surface",
            "control", "mitigation", "residual risk",
            "bowtie", "data flow", "trust boundary",
            "csf", "cybersecurity framework", "iso 27001",
            "security audit", "penetration", "pen test",
            "attack tree", "kill chain", "diamond model",
            "pidpa", "privacy act", "notifiable data breach",
            "compliance", "security posture", "hardening",
        ],
        "description": "NIST-based threat modelling & risk assessment — STRIDE, risk scoring, RMF tracking, control mapping, residual risk, bowtie analysis, executive reports. All three NIST frameworks: SP 800-30 (risk), SP 800-37 (RMF), SP 800-53 (controls) + CSF 2.0.",
        "output_pattern": "agents/threat/assessments/",
    },
    "pm": {
    ...
    "trading": {
        "name": "Trading Agent",
        "emoji": "📈",
        "role": "AI Trading Automation",
        "status": "active",
        "model": "Inherits from Hermes",
        "memory_folder": "agents/trading",
        "skills": [],
        "toolsets": ['web,search,session_memory,clarify'],
        "strengths": [
            "Technical analysis (RSI, MACD, EMA, Bollinger Bands, ATR)",
            "Multi-indicator signal generation with confidence scoring",
            "Automated trade execution via IG Markets API",
            "Risk management (position sizing, stop-loss, daily limits)",
            "Paper trading for strategy validation",
            "Daily/weekly performance reporting",
        ],
        "triggers": [
            "trade", "trading", "buy", "sell", "signal", "market",
            "forex", "cfd", "ig markets", "ig trading", "position",
            "portfolio", "p&l", "profit", "loss", "stop loss",
            "take profit", "rsi", "macd", "ema", "bollinger",
            "technical analysis", "chart", "price", "forex",
            "asx", "stock", "share", "index", "commodity", "gold",
            "oil", "bitcoin", "crypto", "eurusd", "gbpusd", "audusd",
        ],
        "description": "AI Trading Agent — analyses markets using technical indicators, generates BUY/SELL signals, executes trades via IG Markets API, and manages risk automatically. Supports paper trading and live trading.",
        "output_pattern": "config/trading/",
    }
}
